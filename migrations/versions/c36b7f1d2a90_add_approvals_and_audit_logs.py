...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                name="approvalstatus", native_enum=False,
            ),
            nullable=False,
        ),
        sa.Column(
            "required_role",
            sa.Enum(
                "CUSTOMER", "SUPPORT_AGENT", "MANAGER", "ADMIN",
                name="approvalprincipalrole", native_enum=False,
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                "CUSTOMER", "SUPPORT_AGENT", "MANAGER", "ADMIN",
                name="auditprincipalrole", native_enum=False,
            ),
            nullable=True,
        ),
